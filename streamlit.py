...
if rad == 'Spreidingsdiagram':
    ...
    st.text("De blauwe lijn die te zien is in de plot geeft de lijn y = x weer.")
    ' Dit is de lijn die ontstaat als de scheefstand van de elektronische waterpas altijd gelijk is aan het algoritme. De oranje punten zijn de waargenomen scheefstanden.'
