...
if rad == 'Spreidingsdiagram':
    ...
    'De blauwe lijn die te zien is in de plot geeft de lijn st.latex(r'''
     a + ar + a r^2 + a r^3 + \cdots + a r^{n-1} =
     \sum_{k=0}^{n-1} ar^k =
     a \left(\frac{1-r^{n}}{1-r}\right)
     ''') st.latex("y=x") weer. Dit is de lijn die ontstaat als de scheefstand van de elektronische waterpas altijd gelijk is aan het algoritme. De oranje punten zijn de waargenomen scheefstanden.'
