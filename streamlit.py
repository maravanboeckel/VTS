...
if rad == 'Kaart':
    ...
    with col1:
        st.markdown("<h3 style='text-align: center;'>Elektronische waterpas</h2>", unsafe_allow_html=True)
    with col2:
        st.markdown("<h3 style='text-align: center;'>Algoritme</h2>", unsafe_allow_html=True)
